...
PURPOSE:
--------
This module provides the fundamental data structures used throughout Brain-Score
for representing experimental and computational data. These are xarray-based
containers that maintain metadata alongside numeric data.
...
This replaces the full BrainIO assemblies module but keeps all functionality
actually used by Brain-Score models, benchmarks, and data processing.
"""
