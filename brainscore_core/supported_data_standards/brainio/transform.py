...
PURPOSE:
--------
This module provides utilities for transforming and manipulating Brain-Score
data assemblies. It includes functions for subsetting data, efficient indexing,
and other common data operations used across benchmarks and models.

KEY FUNCTIONS:
-------------
- subset(): Filter assemblies by coordinate values
- index_efficient(): Fast indexing by coordinate values

CORE FUNCTIONALITY:
------------------
- Coordinate-based data filtering and selection
- Efficient indexing operations for large assemblies
- Integration with xarray coordinate systems
- Maintains metadata during transformations

This module contains the essential transformation functions from the original
BrainIO transform module that are actually used by Brain-Score code.
"""

import numpy as np

# moved from brain-score.transformations to also use the subset algorithm for new data sets in brainio-contrib
from .assemblies import walk_coords
