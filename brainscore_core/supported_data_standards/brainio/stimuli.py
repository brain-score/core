...
PURPOSE:
--------
This module handles collections of experimental stimuli (images, videos, etc.)
used in Brain-Score benchmarks and model evaluation. It provides a pandas-based
container that links stimulus metadata with actual stimulus files.
...
This replaces the full BrainIO stimuli module but maintains compatibility
with all existing Brain-Score stimulus sets and benchmarks.
"""
