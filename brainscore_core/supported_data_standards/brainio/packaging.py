...
PURPOSE:
--------
This module handles packaging and uploading Brain-Score data (assemblies and
stimulus sets) to AWS S3 storage. It creates the standardized file formats
and directory structures used by the Brain-Score ecosystem.
...
----------------------
Original BrainIO packaging functions required catalog_identifier parameters
to register uploads in CSV lookup tables. These are now optional/removed
since Brain-Score uses direct S3 references instead.
"""
...
def package_stimulus_set(catalog_name, proto_stimulus_set, stimulus_set_identifier, bucket_name="brainio-temp"):
    ...
    # Catalog functionality has been removed - no longer updating catalogs
